...
const EXACT_ALLOWED_OUTER_FILES = new Set(
  [
    ...
    "Contents/Resources/audio/LICENSE-OpenAI-Whisper.txt",
    "Contents/Resources/audio/LICENSE-whisper.cpp.txt",
    "Contents/Resources/audio/audio-artifacts-v1.json",
    "Contents/Resources/audio/qualification-v1.json",
