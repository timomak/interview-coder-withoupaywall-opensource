...
def create(bundle: pathlib.Path, output: pathlib.Path) -> None:
    paths = {
        ...
        "legacyV1ObservedManifest": bundle / "build/legacy-v1-observed-manifest.json",
        ...
        "upgradeStateVerifier": bundle / "tools/upgrade_state.py",
...
def verify(bundle: pathlib.Path, envelope: pathlib.Path) -> None:
    ...
    if (
        ...
        or document["artifactId"] != "P00-V2-CAP-A02"
