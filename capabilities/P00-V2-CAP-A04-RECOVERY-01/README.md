...
The separately governed A04-RECOVERY-01 bundle preserves the rejected A04
revision and changes only terminal member group identity: receipt and journal
publication explicitly establish the requested group, descriptor reopen
validation requires that exact group, and wrong-group terminal/journal replay
