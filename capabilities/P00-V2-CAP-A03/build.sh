...
a02_controller=$bundle_root/../P00-V2-CAP-A02/build/Controller.swift
...
expected_a02_controller_sha=2552af801e0cc32bbc06a39b84cb4a4773547add314381f49969430cdf34f4a4
...
require_hash "$a02_controller" "$expected_a02_controller_sha"
...
/usr/bin/python3 "$bundle_root/source/render-controller.py" \
  "$a02_controller" "$build_root/Controller.swift"
...
/usr/bin/install -m 0555 "$bundle_root/tools/upgrade_state.py" \
  "$payload/libexec/upgrade-state.py"
...
print "artifact_id=P00-V2-CAP-A03"
