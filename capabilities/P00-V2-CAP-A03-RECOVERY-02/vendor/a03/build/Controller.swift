...
let metadataRoot = "\(controllerRoot)/metadata/P00-V2-CAP-A03"
...
func installedPreflight() throws -> [String: Any] {
    ...
    guard let registry = try parseJSON(registryData) as? [String: Any],
          ...
          registry["controllerVersion"] as? String == "P00-V2-CAP-A03",
    ...
    return [
        "schemaVersion": 1,
        "controllerVersion": "P00-V2-CAP-A03",
        "checkedAt": isoNow(),
...
func selfTest(_ arguments: [String]) throws {
    ...
    let output = options["evidence"] ?? "\(evidenceRoot)/P00-V2-CAP-A03/self-test/native-self-test.json"
